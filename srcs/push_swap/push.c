...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/30 02:44:07 by rcross            #+#    #+#             */
/*   Updated: 2019/09/30 02:44:07 by rcross           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	push_commit_ps(t_stack **stack2, t_stack **new)
{
	if (*stack2 == NULL)
	{
		(*new)->next = *new;
